...
从 [Releases](https://github.com/shlouai/tonemate/releases) 下载最新版（当前 v0.1.1）：

| 平台 | 安装包 | 说明 |
| --- | --- | --- |
| macOS | `tonemate_0.1.1_universal.dmg` | 双击 DMG，把 tonemate 拖进「应用程序」 |
| macOS（免安装） | `tonemate_0.1.1_universal.app.zip` | 解压后直接运行 tonemate.app |
| Windows | `tonemate_0.1.1_x64-setup.exe` | 运行安装程序，装好后从开始菜单 / 桌面启动 |
| Windows（绿色版） | `tonemate_0.1.1_x64_portable.zip` | 解压后双击 tonemate.exe 即用 |
...
本地模型会先判断句子的场景（职场交流 / 日常对话 / 技术文档 / 商务正式 / 客服礼貌），再按该场景预设的 3 种语气逐条翻译。
